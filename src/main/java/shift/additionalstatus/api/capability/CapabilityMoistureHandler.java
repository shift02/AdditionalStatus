...
public class CapabilityMoistureHandler {
    ...
    public static void register()
    {
        ...
        {
            @Override
            public NBTBase writeNBT(Capability<IMoistureHandler> capability, IMoistureHandler instance, EnumFacing side)
            {
            ...
            @Override
            public void readNBT(Capability<IMoistureHandler> capability, IMoistureHandler instance, EnumFacing side, NBTBase nbt)
            {
