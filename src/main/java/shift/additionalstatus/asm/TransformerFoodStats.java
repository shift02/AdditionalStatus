...
public class TransformerFoodStats  implements IClassTransformer, Opcodes {
    ...
    public byte[] transform(String name, String transformedName, byte[] bytes) {
        try {
            final String targetClassName = TARGET_CLASS_NAME;//"net.minecraft.util.FoodStats";
    ...
    static class FoodStatusMethodVisitor extends AnalyzerAdapter {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            ...
            if (opcode == INVOKEVIRTUAL
                ...
                mv.visitMethodInsn(INVOKESTATIC, "shift/additionalstatus/asm/vanilla/FoodStatsMethod", "onExhaustion", "(Lnet/minecraft/entity/player/EntityPlayer;F)V", false);
