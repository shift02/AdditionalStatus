...
public class EntityPlayerManager implements IPlayerManager {
	...
	private final static ResourceLocation KYE = new ResourceLocation(AdditionalStatus.MODID, "AdditionalPlayerData");
	...
	public void onEntityConstructing(AttachCapabilitiesEvent.Entity evt) {
		if (evt.getEntity() instanceof EntityPlayer) {
			EntityPlayerManager.register(evt, (EntityPlayer) evt.getEntity());
		}
	}
	...
	public void onEntityJoinWorld(EntityJoinWorldEvent event) {
		...
		if (!event.getEntity().worldObj.isRemote && event.getEntity() instanceof EntityPlayer) {
			...
			ASPacketHandler.INSTANCE.sendTo(
