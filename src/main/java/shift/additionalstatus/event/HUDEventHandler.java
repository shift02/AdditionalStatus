...
public class HUDEventHandler {
	...
	public static final ResourceLocation icons = new ResourceLocation("additionalstatus:textures/guis/icons.png");
	public static final ResourceLocation progress = new ResourceLocation("additionalstatus:textures/guis/progress.png");
	...
	protected void renderMoisture(int width, int height) {
		...
		if (!visibleMoisture || !ASConfig.statusMoisture) return;
		visibleMoisture = false;
	...
	protected void renderStamina(int width, int height) {
		...
		if (!visibleStamina || !ASConfig.statusStamina) return;
		visibleStamina = false;
